...
#test_that("Output is a message", {
  ...
  #expect_message(process_bams(path_to_bams = system.file("extdata", package = "Damsel"), regions = readRDS(test_path("fixtures", "regions.rds"))), "cores missing, [parallel::detectCores()] used instead", ignore.case = TRUE)
#})
