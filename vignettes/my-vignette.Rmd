...
# Installation
```{r eval=FALSE}
devtools::install_github("Oshlack/Damsel", 
                         auth_token = "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")
library(Damsel)
```
...
```{r}
dm_results <- edgeR_results(dge, p.value = 0.01, lfc = 1)
...
knitr::kable(head(peaks), format = "html", table.attr = "style='width:30%;'")
nrow(peaks)
```
