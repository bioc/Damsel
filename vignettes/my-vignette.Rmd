...
```{r}
#b/c lazy loading don't need data call
#data("regions_gatc_drosophila_dm6")
head(regions_gatc_drosophila_dm6)
```
...
plot_counts_all_bams(counts.df, seqnames = "chr2L", start_region = 1, end_region = 40000, n_col = 1) +
...
```{r, fig.height=8, fig.width=10}
plot_counts_all_bams(counts.df, seqnames = "chr2L", start_region = 1, end_region = 40000, n_col = 1) +
  geom_de.res.lfc(de_results.df = add_de(de_results, regions = regions_gatc_drosophila_dm6))
```
