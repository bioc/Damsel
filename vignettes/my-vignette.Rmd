...
* Instead of plotting lfc and de_results separately, we recommend instead using geom_de.res.lfc
...
knitr::kable(head(annotation$all))
```



## 5.4 Interpreting results/Plotting
Now that we have the genes from `get_biomart_genes()`, this can be added as a layer to the previous plots. 
...
# 6. Gene ontology - NOT CURRENTLY AVAILABLE
