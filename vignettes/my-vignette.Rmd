...
plot_counts_all_bams(counts.df, 
                     ...
                     end_region = 40000, 
                     n_col = 1) +
  geom_de.res(de_results.df = add_de(de_results, 
                                     regions = regions_gatc_drosophila_dm6))
```
...
plot_counts_all_bams(counts.df, 
                     ...
                     end_region = 40000, 
                     n_col = 1) +
  geom_regions.lfc(region.df = add_de(de_results, 
                                      regions = regions_gatc_drosophila_dm6))
```
...
plot_counts_all_bams(counts.df, 
                     ...
                     end_region = 40000, 
                     n_col = 1) +
  geom_de.res.lfc(de_results.df = add_de(de_results, 
                                         regions = regions_gatc_drosophila_dm6))
```
...
knitr::kable(head(annotated_peaks))
```
